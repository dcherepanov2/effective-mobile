...
import com.example.effective.mobile.sm.api.exception.JwtAuthenticationException;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            throw new JwtAuthenticationException("Ваш токен невалиден", new SignatureException("Ваш токен невалиден"));
        }
